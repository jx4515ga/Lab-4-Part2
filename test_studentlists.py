...
class TestStudentLists(TestCase):
    ...
    def test_remove_student_notIn_list(self):
        ...
        test_class.add_student('Jelly Roll')
        test_class.add_student('Anna')
        with self.assertRaises(StudentError):
            test_class.remove_student('Anna')
    ...
    def test_is_class_full_when_class_is_full(self):
        ...
        test_class.add_student('Jamie')
        test_class.add_student('Jamileth')
    ...
    def test_class_full_when_class_empty(self):
